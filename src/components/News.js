...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=254d824d36504c56a48a418b69c91795&page=1&pageSize=${this.props.pageSize}`;
    ...
    handlePrevClick = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=254d824d36504c56a48a418b69c91795&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        this.setState({ loading: true })
        let data = await fetch(url);
        let parsedData = await data.json()
        console.log(parsedData)
    ...
    render() {
        ...
        return (
            <div className="container my-3">
                <h1 className="text-center">NewsFlash - Top Headline</h1>
