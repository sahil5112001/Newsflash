...
export class News extends Component {
    ...
    async updateNews(pageNo) {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=254d824d36504c56a48a418b69c91795&page=${this.state.page}&pageSize=${this.props.pageSize}`;
    ...
    handlePrevClick = async () => {
        ...
        //     loading: false
        // })
        this.state.articles({ page: this.state.page - 1 })
        this.updateNews()
    }
